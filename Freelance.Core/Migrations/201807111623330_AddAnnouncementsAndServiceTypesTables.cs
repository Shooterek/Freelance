namespace Freelance.Core.Migrations
{
    ...
    public partial class AddAnnouncementsAndServiceTypesTables : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        AdvertiserId = c.String(maxLength: 128),
                        Summary = c.String(),
                        Description = c.String(),
                        ExpectedHourlyWage = c.Decimal(nullable: false, precision: 18, scale: 2),
                        Location = c.String(),
                        ServiceTypeId = c.Int(nullable: false),
                    })
                .PrimaryKey(t => t.AnnouncementId)
                .ForeignKey("dbo.AspNetUsers", t => t.AdvertiserId)
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Announcements", "ServiceTypeId", "dbo.ServiceTypes");
            ...
            DropIndex("dbo.Announcements", new[] { "ServiceTypeId" });
